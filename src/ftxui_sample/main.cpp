...
// configuration step. It creates a namespace called `Zylo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Zylo::cmake::project_name, Zylo::cmake::project_version) };
